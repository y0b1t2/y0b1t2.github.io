...
{{< caption `バックテストの結果（年率リターン16%、最大ドローダウン11%）` >}}![](20251208224916.png){{< /caption >}}
...
{{< caption `アプリのメイン画面` >}}![](20251208231234.png){{< /caption >}}

{{< caption `アプリのサブ画面` >}}![](20251208231237.png){{< /caption >}}
